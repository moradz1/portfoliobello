...
function vlkSlider(sliderDiv, options) {
    ...
    stylePseudoElem.innerHTML +=
        ".slider-arrow-left-in:before {content: ''; position: absolute; top: 50%; left: 0px; transform: translateY(-50%) rotate(45deg); width: 10px; height: 10px; border-bottom: 2px solid violet; border-left: 2px solid violet;} ";

    stylePseudoElem.innerHTML +=
        ".slider-arrow-left-in {position: absolute;top: 50%;width: 60px;height: 2px;background-color: violet;-webkit-transform: translateY(-50%);-ms-transform: translateY(-50%);transform: translateY(-50%);z-index: 50;pointer-events: none;} ";
    ...
    stylePseudoElem.innerHTML +=
        ".slider-arrow-right-in {position: absolute;top: 50%;width: 60px;height: 2px;background-color: violet;-webkit-transform: translateY(-50%);-ms-transform: translateY(-50%);transform: translateY(-50%);pointer-events: none;}";

    stylePseudoElem.innerHTML +=
        ".slider-arrow-right-in:before {content: '';position: absolute;top: 50%;right: 0px;transform: translateY(-50%) rotate(-45deg);width: 10px;height: 10px;border-bottom: 2px solid violet;border-right: 2px solid violet;}";
